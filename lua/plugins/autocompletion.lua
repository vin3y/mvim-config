return { -- Autocompletion
  ...
  dependencies = {
    ...
    'hrsh7th/cmp-buffer',
    'hrsh7th/cmp-path',
    'p00f/clangd_extensions.nvim', -- Enhanced clangd LSP features
  ...
  config = function()
    ...
    local kind_icons = {
      ...
      Operator = '󰆕',
      TypeParameter = '󰊄',
      Namespace = '󰦮', -- Namespace icon
      Template = '󰊢', -- Template icon
    }
    -- Load C++ specific snippets
    require('luasnip').filetype_extend('cpp', { 'cpp' })

    -- Add some C++ specific completion settings
